...
4. Replace **926831051300** in the whole project with your AWS Account ID
...
# Datacenter Map
Remember to adjust **926831051300** in workflow before execution.
...
* Replaced 926831051300 in the whole project (replace all in all files) with your AWS Account ID
  * **REMEMBER!** Push all changes to your forked repository!
